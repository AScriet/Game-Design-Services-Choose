...
class GameDesign implements ActionListener
  {  
   JLabel displayLabel;
   JButton nextButton;
   JButton prevButton;
   ...
   ResourceBundle gamedesignResources;
   ...
   GameDesign()
     {  
      try
        {
         gamedesignResources = ResourceBundle.getBundle("resources.GameDesignServicesChoose",Locale.getDefault());
        }
      ...
      JFrame jfrm = new JFrame(gamedesignResources.getString("GameDesignServicesChoose"));  
      ...
      prevButton = new JButton(gamedesignResources.getString("Prev"));
      prevButton.setActionCommand("Prev");
      buttonPanel.add(prevButton);
      prevButton.addActionListener(this);
      
      nextButton = new JButton(gamedesignResources.getString("Next"));
      ...
      /*========================*/
      /* Load the game design choose program. */
      /*========================*/
      
      clips = new Environment();
      
      clips.load("gamedesign.clp");
   ...
   private void nextUIState() throws Exception
     {
      ...
      if (fv.getFactSlot("state").toString().equals("final"))
        { 
         ...
         nextButton.setText(gamedesignResources.getString("Restart")); 
         prevButton.setVisible(true);
        }
      else if (fv.getFactSlot("state").toString().equals("initial"))
        {
         nextButton.setActionCommand("Next");
         nextButton.setText(gamedesignResources.getString("Next"));
      ...
      for (int i = 0; i < pv.size(); i++) 
        {
         ...
         if (bv.toString().equals(selected))
            { rButton = new JRadioButton(gamedesignResources.getString(bv.toString()),true); }
         else
            { rButton = new JRadioButton(gamedesignResources.getString(bv.toString()),false); }
      ...
      String theText = gamedesignResources.getString(fv.getFactSlot("display").symbolValue());
   ...
   public static void main(String args[])
     {  
      ...
      SwingUtilities.invokeLater(
        new Runnable() 
          {  
           public void run() { new GameDesign(); }  
          });   
     }  
  }